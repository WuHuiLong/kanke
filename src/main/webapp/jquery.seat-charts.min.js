    ...
    e.fn.seatCharts=function(t){
        ...
        var n=this,r={},i=[],s,o={
            ...
            legend:{node:null,items:[]},click:function(){
                ...
                else if(this.status()=="selected"){return"available"}
            ...
            blur:function(){return this.status()},seats:{}
        },
            u=function(t,n){
            return function(i){
                var s=this;
                ...
                s.style=function(){return arguments.length==1?function(e){var t=s.settings.style;
                if(e==t){return t}s.settings.status=e!="focused"?e:s.settings.status;
